...
ALTER TABLE PAGO ADD CONSTRAINT FKPAGO159984 FOREIGN KEY (MATRICULAid, id_gh, id_alumno) REFERENCES MATRICULA (id, id_gh, id_alumno);
ALTER TABLE CUOTA ADD CONSTRAINT FKCUOTA567098 FOREIGN KEY (id_pago, id_gh, id_alumno, PAGOMATRICULAid) REFERENCES PAGO (id, id_gh, id_alumno, MATRICULAid);
